                  ...
                  >
                    {self && 
                      <div style={{display:'flex', flexDirection: 'column', alignItems: 'flex-end'}}>
                        {z.status !== 'R' && <div style={{paddingRight: '1ex', color: 'silver'}}>{z.status}</div>}
                        {y.arr.length - 1 === cidx && <div style={{paddingRight: '1ex', color: 'silver'}}>{y.time}</div>}
                      </div>
                    }
                    <Feed.Content 
                      content={z.msg} 
                    ...
                    />
                    {!self && y.arr.length - 1 === cidx && <div style={{paddingLeft: '1ex', color: 'silver'}}>{y.time}</div>}
                  </div>
                )}
              </div>
            </Feed.Event>
